...
#SBATCH --output="hybrid_finite.out"
...
@everywhere params = (; L=2000.0, a0=10.0, αSC=0.0, αSM=40.0, g=0.17, τ=0.8, μSC=10.0, USC=-32.0) # nm & meV (ħ²/mₑ)
...
@everywhere begin
    ...
    fp(Vz, μ) = calculate_fixedpoint_npv(h, GS.Spectrum(), nothing; params..., Vz, μ)
end
