...
@everywhere params = (; L=Inf, α_SM=40, α_SC=40, a0=10.0, U_SC=-30.0, U_SM=-0.0, τ=1.0, μ_SC=20) # nm & meV (ħ²/mₑ)

@everywhere μs_SM = range(-10.0, -6.0, 48) #mev (ħ²/mₑ)
@everywhere Vzs = range(0, 1.0, 48)        #mev (ħ²/mₑ)
...
begin
    ...
    Serialization.serialize("results/data/multi_to_hybrid_$params.dat", (params, Vzs, μs_SM, seis))
end
